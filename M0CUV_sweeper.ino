...
const int SCLK=9;
const int RESET=12;
#define pulseHigh(pin) {digitalWrite(pin, HIGH); delay(5); digitalWrite(pin, LOW); }
...
void setup() {
  ...
  Serial.println("K6BEZ Antenna Analyser, modifications by M0CUV and NI2O");
  Serial.println("Commands: ABCDEFNOQSRrV?");
