...
#define __LCD4WIRE__ // I2CLCD or LCD4WIRE
#include <Wire.h>
...
#if defined (__LCD4WIRE__)
#include <LiquidCrystal.h>
LiquidCrystal lcd(7,6,5,4,3,2); // LCD keypad shield from ebay
#endif

#if defined (__I2CLCD__)
#include <LiquidCrystal_I2C.h>
LiquidCrystal_I2C lcd(0x27,2,1,0,4,5,6,7,3,POSITIVE); // wierd I2C backpack from ebay - frees up loads of pins
#endif
...
void setup() {
  ...
  // Start the LCD and write some brag stuff to it
  lcd.begin(16,2);
  lcd.clear();
  lcd.setCursor(0,0);
